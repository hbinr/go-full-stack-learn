 ...
 *  4. const 定义对象类型的常量，其属性是可以进行修改的，但整体不能修改
 *  5. const 定义数组类型的常量，其元素是可以进行修改的，但整体不能修改
 *  6. cosnt 定义引用类型的常量时，其元素和整体都能修改
 */
...
user.age = 20  // 属性可以更改，因为user指向的内存地址并没有改变，所以修改属性
console.log('user.age: ', user.age);

// 注意：但是user本身是不允许修改的，user指向的内存地址会发生变化
// user = {
